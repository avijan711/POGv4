...
import { Chip, Tooltip, Box, Typography, SxProps, Theme } from '@mui/material';
import {
...
import { ReferenceChange } from './types';
...
const ReferenceChip: React.FC<ReferenceChipProps> = ({ 
  ...
  const getTooltipText = () => {
    const source = reference_change.source === 'supplier' 
      ...
      : reference_change.source === 'inquiry_item'
  ...
  const pulsingDotSx: SxProps<Theme> = {
    position: 'absolute',
    top: -2,
    right: -2,
    width: 8,
