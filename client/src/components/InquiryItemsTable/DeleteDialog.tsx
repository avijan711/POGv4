...
import { DeleteDialogProps, DeleteType } from '../../types/inquiry';

interface DialogContentInfo {
  title: string;
  message: string;
  description: string;
}

const getDialogContent = (type: DeleteType | null): DialogContentInfo => {
  switch (type) {
  case 'reference':
    return {
...
const DeleteDialog: React.FC<DeleteDialogProps> = ({
  ...
  const dialogContent = getDialogContent(type);
