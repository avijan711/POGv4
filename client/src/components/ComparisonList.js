          ...
          <TableBody>
            {sortedComparisons.length === 0 ? (
              ...
              sortedComparisons.map((comparison) => (
                <TableRow key={comparison.inquiryID}>
                  <TableCell>{comparison.customNumber}</TableCell>
                  <TableCell>{new Date(comparison.date).toLocaleString()}</TableCell>
                  <TableCell align="right">{comparison.itemCount}</TableCell>
                  <TableCell align="right">{comparison.supplierCount || 0}</TableCell>
                  <TableCell align="center">
                    <Tooltip title="Start Comparison">
                      <IconButton 
                        size="small"
                        onClick={() => handleStartComparison(comparison.inquiryID)}
                        color="primary"
                      >
                        <CompareIcon />
                      </IconButton>
